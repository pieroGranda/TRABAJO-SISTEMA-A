		...
		<div class="col-xs-12">
			<div class="box box-primary">
				<div class="box-header">
					<h3 class="box-title"><?= lang('list_results'); ?> <a href="../report/GenerateGeneral/" target="_blank">CONSULTA DE COMPROBANTES Y VENTA</a> - <a href="../report/Generate/" target="_blank">GENERAR COMPROBANTE</a></h3>
				</div>
				<div class="box-body">
