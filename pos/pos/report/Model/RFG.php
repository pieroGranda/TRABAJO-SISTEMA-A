...
$title = "REPORTE DE FACTURAS GESTIONADAS";
$cell = array("FACTURA","EMPRESA","RUC","MONTO","FECHA");
$valor = array(':inicial'=>$inicial,':final'=>$final);
$width = array(30,60,30,23,50);
$align = array("C","C","C","R","C");
$height = 6;
$sql = "SELECT `N DOC`, `EMPRESA`, `RUC`, `MONTO`, `FECHA` FROM `Facturas` WHERE `FECHA` BETWEEN :inicial AND :final";
/*** Header del reporte RBG ***/
$Reporte->headerReport($title, $pdf);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(31,5,'MONTO FACTURADO');
$pdf->SetFont('Arial','',8);
$pdf->Cell(5,5,':',0,0,'C');
